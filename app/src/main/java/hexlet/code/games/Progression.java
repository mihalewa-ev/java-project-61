...
public class Progression {
    ...
    public static final int maxDifferenceBetweenNumber = 10;
     ...
     * {@link #getArResult()} to prepare game data and passes it to the {@link Engine#play(String, String[][])} method.</p>
     */
